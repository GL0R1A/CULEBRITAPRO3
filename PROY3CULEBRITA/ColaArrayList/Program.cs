...
namespace culebrita
{
    class ProgramColaArrayList
    {
        ...
        private static bool MoverLaCulebrita(ca culebra, Point posiciónObjetivo,
        ...
        private static Point MostrarComida(Size screenSize, ca culebra)
        {
