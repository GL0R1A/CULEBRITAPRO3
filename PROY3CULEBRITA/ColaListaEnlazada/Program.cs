...
namespace culebrita
{
    class ProgramColaListaEnlazada
    {
        ...
        private static bool MoverLaCulebrita(cle culebra, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            ...
            culebra.insertarValor(posiciónObjetivo);
            ...
            // Quitar cola
            if (culebra.numelement > longitudCulebra)
            {
                var removePoint = (Point)culebra.quitarValor();
                Console.BackgroundColor = ConsoleColor.Black;
        ...
        private static Point MostrarComida(Size screenSize, cle culebra)
        {
        ...
        public void MainListaEnlazada()
        {
            ...
            culebrita.insertarValor(posiciónActual);
