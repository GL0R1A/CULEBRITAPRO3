...
namespace culebrita
{
    class pca
    {
        ...
        private static bool MoverLaCulebrita(lclarr.clarr culebra, Point posiciónObjetivo,
            int longitudCulebra, Size screenSize)
        {
            ...
            // Quitar cola
            if (culebra.numeleme() > longitudCulebra)
            {
        ...
        private static Point MostrarComida(Size screenSize, lclarr.clarr culebra) //aqui
        {
        ...
        public void Main()
        {
            ...
            var culebrita = new lclarr.clarr();
